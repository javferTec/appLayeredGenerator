...
public class SpringProjectConfig {
    ...
    private final String type = "maven-project";                        // El tipo de proyecto, en este caso un proyecto Maven

    // Lista mutable de dependencias que el proyecto va a usar. Inicialmente vacía.
    private final List<SpringProjectDependency> dependencies = new ArrayList<>(); // Listado de dependencias del proyecto
